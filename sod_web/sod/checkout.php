...
<form action="forceok.php" method="post">
...
<body>
  <?php 
	include('DbCon.php'); 
        ...
        <th class=text-center>Weekly Reboot Checkout Portal - PR/Watford </th>" ;
        echo "</table>"; 
        ...
        $host1=$_GET['host'];
        $sql = "SELECT * FROM sysboot where host like '$host1' order by Status";
	...
	echo "</table>";
?>
<input type="hidden" name="host" value=<?php print "$host1" ?>>
<select name="SA">
  <option hidden="true">Please select your name</option>
  <option value="Admin1">Admin1</option>
  <option value="Admin2">Admin2</option>
</select>
<input name = "Force_OK" type = "submit" value = "Force OK" />
</form>
