...
<body>
  <?php
        ...
        <tr ><th  align=center cellpadding=20px>UNIX SOD Status Report - TY3</th> </td> ";
        echo "</table>";
        ...
        echo "<table border=1 align=center cellpadding=20px> ";
        echo "<tr >";
        echo "<th width=30% align=center >Overall TY3 SOD Status </th>";
        ...
        echo "<td class=danger ><a href='http://website1:8080//sod/sod_summ.php'>TY3</a></td>";
        echo "</tr>";
        echo "</table>";
