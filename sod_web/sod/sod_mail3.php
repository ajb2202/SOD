...
<body>
  <?php
        include('DbConny4.php');
        echo "<table  border=1 align=center cellpadding=20px>
        <tr ><th  align=center cellpadding=20px>UNIX SOD Status Report - NY4</th> </td> ";
        echo "</table>";
        ...
        echo "<table border=1 align=center cellpadding=20px> ";
        echo "<tr >";
        echo "<th width=30% align=center >Overall NY4 SOD Status </th>";
        ...
        echo "<td class=danger ><a href='http://website3/sod/sod_summ.php'>NY4</a></td>";
        echo "</tr>";
        echo "</table>";
